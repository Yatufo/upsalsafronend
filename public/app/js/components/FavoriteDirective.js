/* App Module */
var FavoriteDirectiveController = function($scope, service) {
...
angular.module('eventify').directive('favorite', function() {
  return {
    restrict: 'E',
    replace: true,
    scope: {
    ...
    controller: ['$scope', 'RatingService', FavoriteDirectiveController],
    templateUrl: 'views/components/favorite.html'
  };
});
